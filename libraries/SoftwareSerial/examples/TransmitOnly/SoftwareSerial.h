...
//if(speed>100000){
   _rx_delay_centering_us = (bit_delay / 2) - 1;
   _rx_delay_intrabit_us = bit_delay;  // 2
//}else{
//   _rx_delay_centering_us = (bit_delay / 2)+5;
//   _rx_delay_intrabit_us = bit_delay;  // 2
//}
...
inline void SoftwareSerial::recv()
{
    ...
    */
    ...
    __ASM volatile(
     ...
     {
      d |= 0x00; //loop should be consistent for RX HIGH or LOW
     }
      }
      if (_inverse_logic)
      {
